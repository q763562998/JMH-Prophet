...
def createast():
    ...
    paths=[]
    alltokens=[]
    # dirname = '/home/zhs/gnn/zhs/3'
    dirname='/home/zhs/predict/0110model/ast/data/eclipse/8.0.1/alljavacodeandcallgraphNoNameAddAST2'
    ...
    print(vocabdict)
    # print("zhs")
    # 这个astdict 就是一个字典集 key是文件的相对路径，value就是生成的树
    # print(astdict)
...
if __name__ == '__main__':
    ...
    jsObj = json.dumps(treedict)
    
    fileObject = open('/home/zhs/predict/0110model/ast/data/eclipse/8.0.1/json/faast0113.json', 'w')
