...
for i in range(len(dataset)):
    ...
    train_indices = [idx for idx in indices if idx != i]
    ...
    for epoch in range(1, num_epochs):
        ...
        for names_batch, namelen_batch, tokns_batch, graphs_batch, labels_batch ,method in test_loader:
            current_method=method
        
        print(f"test data {i + 1} method: {current_method}, time {after_time - before_time}")
